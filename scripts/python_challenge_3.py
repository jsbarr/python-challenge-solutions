...
lst = re.findall(pattern, mess)
extraction_patternstr = "[A-Z]{3}[a-z][A-Z]{3}"
extraction_pattern = re.compile(extraction_patternstr)
print("".join([re.search(extraction_pattern,string).group()[3] for string in lst]))
